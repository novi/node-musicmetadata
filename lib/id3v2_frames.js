...
exports.readData = function readData(b, type, flags, major) {
  ...
  switch (type) {
    ...
    case 'USLT':
      ...
      lyrics.language = decodeString(b, 'iso-8859-1', offset, offset + 3).text;
      offset += 3;
      
      var end = findZero(b, offset, length, encoding);
      if (encoding === 'utf16') end += 1;
      lyrics.descriptor = decodeString(b, encoding, offset, end);
